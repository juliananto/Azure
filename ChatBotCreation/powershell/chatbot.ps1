...
param(
    ...
    [string]
    $qnaServicesTemplate = "https://raw.githubusercontent.com/juliananto/Azure/master/ChatBotCreation/templates/qnamaker_template.json",

    [string]
    $chatBotTemplate = "https://raw.githubusercontent.com/juliananto/Azure/master/ChatBotCreation/templates/bot_template.json",
